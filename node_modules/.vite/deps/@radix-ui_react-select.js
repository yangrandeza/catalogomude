...
function useComposedRefs2(...refs) {
  return React19.useCallback(composeRefs3(...refs), refs);
}
...
function createSlot3(ownerName) {
  ...
  const Slot22 = React21.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime13.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React21.isValidElement(newElement) ? React21.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var useLayoutEffect22 = (globalThis == null ? void 0 : globalThis.document) ? React25.useLayoutEffect : () => {
};
...
var useLayoutEffect23 = (globalThis == null ? void 0 : globalThis.document) ? React26.useLayoutEffect : () => {
};
...
var PopperAnchor = React28.forwardRef(
  (props, forwardedRef) => {
    ...
    return virtualRef ? null : (0, import_jsx_runtime15.jsx)(Primitive3.div, { ...anchorProps, ref: composedRefs });
  }
);
...
var Portal = React29.forwardRef((props, forwardedRef) => {
  ...
  return container ? import_react_dom2.default.createPortal((0, import_jsx_runtime16.jsx)(Primitive.div, { ...portalProps, ref: forwardedRef }), container) : null;
});
...
var useLayoutEffect24 = (globalThis == null ? void 0 : globalThis.document) ? React30.useLayoutEffect : () => {
};
...
var RemoveScroll = React35.forwardRef(function(props, parentRef) {
  ...
  return React35.createElement(
    React35.Fragment,
    null,
    enabled && React35.createElement(SideCar, { sideCar: effectCar, removeScrollBar, shards, noRelative, noIsolation, inert, setCallbacks, allowPinchZoom: !!allowPinchZoom, lockRef: ref, gapMode }),
...
function RemoveScrollSideCar(props) {
  ...
  var Style = React36.useState(styleSingleton)[0];
  ...
  return React36.createElement(
    React36.Fragment,
    null,
    inert ? React36.createElement(Style, { styles: generateStyle(id) }) : null,
...
var Select = (props) => {
  ...
  return (0, import_jsx_runtime18.jsx)(Root2, { ...popperScope, children: (0, import_jsx_runtime18.jsxs)(
    SelectProvider,
    {
      required,
      scope: __scopeSelect,
      ...
      disabled,
      children: [
        (0, import_jsx_runtime18.jsx)(Collection.Provider, { scope: __scopeSelect, children: (0, import_jsx_runtime18.jsx)(
        ...
        isFormControl ? (0, import_jsx_runtime18.jsxs)(
          SelectBubbleInput,
          {
            "aria-hidden": true,
            required,
  ...
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      ...
      return frag ? ReactDOM6.createPortal(
        (0, import_jsx_runtime18.jsx)(SelectContentProvider, { scope: props.__scopeSelect, children: (0, import_jsx_runtime18.jsx)(Collection.Slot, { scope: props.__scopeSelect, children: (0, import_jsx_runtime18.jsx)("div", { children: props.children }) }) }),
        frag
      ) : null;
    }
  ...
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime18.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, children: (0, import_jsx_runtime18.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectViewport = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
      ...
      (0, import_jsx_runtime18.jsx)(Collection.Slot, { scope: __scopeSelect, children: (0, import_jsx_runtime18.jsx)(
        Primitive.div,
        {
...
var SelectArrow = React38.forwardRef(
  (props, forwardedRef) => {
    ...
    return context.open && contentContext.position === "popper" ? (0, import_jsx_runtime18.jsx)(Arrow2, { ...popperScope, ...arrowProps, ref: forwardedRef }) : null;
  }
);
